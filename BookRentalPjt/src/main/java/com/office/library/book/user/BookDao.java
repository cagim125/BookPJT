...
public class BookDao {
	...
	public List<BookVo> searchBookConfirm(BookVo bookVo) {
		...
		try {
			...
			RowMapper<BookVo> rowMapper =
					BeanPropertyRowMapper.newInstance(BookVo.class);
	...
	public int insertRentalBook(int b_no, int u_m_no) {
		...
		String sql = "INSERT INTO tbl_rental_book(b_no, u_m_no, rb_start_date,"
				+ "rb_reg_date, rb_mod_date) "
				+ "VALUES(?, ?, NOW(), NOW(), NOW())";
	...
	public List<RentalBookVo> selectRentalBooks(int u_m_no) {
		...
		try {
			...
			RowMapper<RentalBookVo> rowMapper =
					BeanPropertyRowMapper.newInstance(RentalBookVo.class);
	...
	public int selectHopeBook(HopeBookVo hopeBookVo) {
		...
		try {
			...
			hopeBookVos = jdbcTemplate.query(sql, rowMapper, hopeBookVo.getHb_name());
	...
	try {
		...
		RowMapper<HopeBookVo> rowMapper =
				BeanPropertyRowMapper.newInstance(HopeBookVo.class);
