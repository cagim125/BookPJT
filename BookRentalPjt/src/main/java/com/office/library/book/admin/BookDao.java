	...
	public int insertBook(BookVo bookVo) {
		...
		try {
			result = jdbcTemplate.update(sql,
					...
					bookVo.getB_reg_date(),bookVo.getB_mod_date()
					);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//		System.out.println("[BookDao] selectBookBySearch(BookVo bookVo)");
//		
...
//		System.out.println(bookVos.size());
	...
	public void updateHopeBookResult(int hb_no) {
		System.out.println("[adminBookDao] updateHopeBookResult()");
